# -*- coding: utf-8 -*-
"""
Created on Wed May 27 10:43:49 2015
...
def gradient_descent(features, values, theta, alpha, num_iterations):
    ...
    for i in range(num_iterations):
        value_predicted = np.dot(features, theta)		
        theta = theta - (alpha / m) * np.dot((value_predicted - values), features)		
...
def predictions(dataframe):
    ...
    features = dataframe[['precipi', 'Hour', 'mintempi', 'maxdewpti']]
    ...
    alpha = 0.07 # please feel free to change this value
